...
o1,d1 = get_list_of_point(trace_1)
o2,d2 = get_list_of_point(trace_2)

def intersection(lst1, lst2): 
    lst3 = [value for value in lst1 if value in lst2] 
    return lst3 

inter = intersection(o1,o2)

print("Part 1")
print(min(abs(a)+abs(b) for a,b in inter))

print("Part 2")
inter = sorted(inter, key = lambda i:d1[i]+d2[i])
print(min(d1[i]+d2[i] for i in inter))
